...
def main(question):
	...
	parser.add_argument('--image_path', type=str, default = 'Data/img_2.jpg',
                       help='Image Path')
	parser.add_argument('--model_path', type=str, default = 'Data/model2.ckpt',
                       help='Model Path')
	...
	print ("Answer is:", ans_map[pred[0]])
	answerResult = ans_map[pred[0]]
	return answerResult
	#exit()
